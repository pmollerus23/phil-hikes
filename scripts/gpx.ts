...
export function parseGpx(xml: string, filename: string, override: Override = {}) {
 ...
 const detail:TripDetail={schemaVersion:1,id,paths,geojson:geometry(paths,id),sourceMetadata:root.metadata??null,sourceExtensions:root.extensions??null,photoStops:[],photos:[]};
