...
export interface Override { title?: string; dates?: Trip['dates']; region?: string; tags?: string[]; notes?: string; pathIds?: string[]; statsPathIds?: string[]; statsLabel?: string; waypoints?: Record<string, Partial<Pick<Waypoint,'kind' | 'name' | 'description' | 'lat' | 'lon'>>> }
